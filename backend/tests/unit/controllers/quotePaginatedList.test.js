...
const { createTestQuotes } = require('../../fixtures/quote.fixtures');

describe('Quote Paginated List Controller', () => {
  let QuoteModel;
  let ClientModel;
  let AdminModel;
  ...
  test('should return paginated quote list', async () => {
    const quotePaginatedList = require('@/controllers/appControllers/quoteController/paginatedList');
    await createTestQuotes(QuoteModel, client._id, admin._id, 10);
  ...
  test('should return empty array when no quotes', async () => {
    const quotePaginatedList = require('@/controllers/appControllers/quoteController/paginatedList');
